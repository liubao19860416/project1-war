...
public class BygjValidateController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BygjValidateController.class);
    ...
    public void validateCode(HttpServletRequest request,HttpServletResponse response) {
        ...
        logger.info("获取验证码request参数列表为："+JSON.toJSONString(request.getParameterMap()));
        logger.info("获取验证码为("+RandomValidateCode.RANDOMCODEKEY+")："+validateCode.getCodeString());
        try {
