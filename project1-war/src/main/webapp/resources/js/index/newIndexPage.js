(function (window, console) {
	...
	//Usage: urlUtils.getOneParam(key, url);

} (window, "undefined" != typeof console ? console : void 0));
		...
		monitorHref.each(function() {
			...
			if (patt.test(href)) {
				...
				if (patt_08.test(href)) {
					var srcPre;
					pCode = urlUtils.getOneParam('p', href);
//					console.info(pCode);
...
}(jQuery, window.ECar || (window.ECar = {})));;(function($) {
